...
**GitHub:** https://github.com/romaxnova/lux-arbitrage

The Next.js dashboard deploys to Vercel; the API runs separately (Railway, Render, or your PC).

1. Import at [vercel.com/new](https://vercel.com/new) → paste repo URL
2. Set **Root Directory** to `frontend`
3. Add env: `NEXT_PUBLIC_API_URL` = your public API URL (optional for UI-only preview)

Or CLI: `vercel login` then `.\scripts\deploy-vercel.ps1`
